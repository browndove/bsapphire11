        ...
        const jobs = {{
            "vp-software-engineering": {{
                ...
                desc: `
                    ...
                    <p><strong>Work Setup:</strong> Our primary hub is located in Accra, but we lean strongly into hybrid possibilities natively for senior structural staff. Flexibility guaranteed.</p>
                `
            }},
            "default": {{
                        ...
                        <div class="job-content-container">
                            ...
                            <div class="job-apply-block slide-up delay-3">
                                ...
                                <form onsubmit="event.preventDefault(); alert('Application Received. Our HR team will review and contact you shortly.');">
                                    ...
                                    <div class="form-group">
                                        <label>Phone Contact (Ghana valid) <span class="form-required">*</span></label>
...
print("SUCCESS: Generated job application page and mapped career links.")
