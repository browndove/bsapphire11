      ...
      <div className="mx-auto max-w-6xl px-3 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8 sm:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-2 sm:mb-3">Business Lead</h2>
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
              Join BLVCK SAPPHIRE and drive AI innovation across Ghana
            </p>
          </div>
          ...
          <div className="group rounded-xl sm:rounded-2xl border border-white/60 dark:border-gray-700/60 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl overflow-hidden shadow-xl shadow-gray-300/30 dark:shadow-gray-900/30 transition-[background-color,border-color,box-shadow] duration-200 hover:shadow-2xl hover:bg-white/95 dark:hover:bg-gray-900/95 hover:border-white/80 dark:hover:border-gray-700/80">
            ...
            <div className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="mb-6 sm:mb-8">
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 p-3 sm:p-4">
                    ...
                    <div className="font-bold text-gray-900 dark:text-white text-sm sm:text-base">2+ Years</div>
                  </div>
                  <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 p-3 sm:p-4">
                    <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">Location</div>
                    <div className="font-bold text-gray-900 dark:text-white text-sm sm:text-base">Accra</div>
                  </div>
                  <div className="rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 p-3 sm:p-4">
                ...
                <div className="mb-6 sm:mb-8">
                  <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                    We're looking for a Business Lead to support the growth of BLVCK SAPPHIRE in Ghana. You'll
                    coordinate business development, manage key stakeholder relationships, and drive the day-to-day
                    operations of our innovative AI and cybersecurity solutions.
                  </p>
                </div>

                {/* Key Points */}
                <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-6 sm:mb-8">
                  {["Business Development", "Stakeholder Management", "Project Coordination", "Operations Support"].map(
                    (point, index) => (
                      <div
                        key={index}
              ...
              <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a 
                  href="mailto:info@blvcksapphire.com?subject=Business Lead Application&body=Hi, I'm interested in applying for the Business Lead position at BLVCK SAPPHIRE. Please find my application details below."
                ...
                <a 
                  href="https://www.linkedin.com/posts/blvck-sapphire_business-lead-role-overview-we-are-seeking-activity-7398777998805577729-pede?utm_source=share&utm_medium=member_ios&rcm=ACoAADVgvSEBi2MDLqmgdSh6i8Un_9O5kAPwTJg"
                  target="_blank"
